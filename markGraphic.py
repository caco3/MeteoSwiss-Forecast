...
def markGraphic(inputFile, outputFile, metaFile, x, y, w, h, fakeTime, test):
...
if __name__ == '__main__':
    ...
    markGraphic(inputFile=args.i.name, outputFile=args.o.name, metaFile=args.m, x=args.x, y=args.y, w=args.w, h=args.h, fakeTime=args.fake_time, test=args.test)
